...
import (
	"gitee.com/zlinkgroup/uepc-swupl/utils/filetype/matchers"
	"gitee.com/zlinkgroup/uepc-swupl/utils/filetype/types"
)
...
// IsDocument checks if the given buffer is an doc type
